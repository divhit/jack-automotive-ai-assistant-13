...
```
Hi {{customer_name}}! Jack from {{organization_name}} here. {{#if previous_summary}}Hope you're doing well - following up on our conversation.{{else}}I'm an AI assistant specializing in vehicle financing, and I can help get you driving quickly.{{/if}} I have experienced financing experts behind me who work with all credit situations. Would you like to chat now or prefer I follow up via text?
```

### **Why This Works:**
- ✅ **Flexible for all scenarios** (first contact, follow-ups, continuations)
- ✅ **Uses dynamic variables** (`customer_name`, `organization_name`)
- ✅ **Conditional logic** (checks for `previous_summary`)
...
**Copy this into the "System prompt" field in ElevenLabs:**
