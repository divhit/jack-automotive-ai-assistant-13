  ...
  return (
    <div className="p-4 space-y-4 overflow-y-auto h-full">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="bg-white border border-stone-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] text-stone-500 uppercase tracking-wider">Lead Score</span>
          </div>
        ...
        <div className="bg-white border border-stone-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] text-stone-500 uppercase tracking-wider">Conversion</span>
          </div>
        ...
        <div className="bg-white border border-stone-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] text-stone-500 uppercase tracking-wider">Contact Attempts</span>
          </div>
          <div className="text-3xl font-bold text-stone-900">
            {analyticsData.contactAttempts || 0}
          </div>
          <div className="text-xs text-stone-400 mt-1">total attempts</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {/* Funding Readiness */}
        <div className="bg-white border border-stone-200 rounded-lg p-4">
          <span className="text-[11px] text-stone-500 uppercase tracking-wider">Funding Readiness</span>
          <div className="mt-3">
        ...
        {/* Sentiment */}
        <div className="bg-white border border-stone-200 rounded-lg p-4">
          <span className="text-[11px] text-stone-500 uppercase tracking-wider">Sentiment</span>
          <div className="mt-3">
      ...
      {/* Bottom: Chase Status */}
      <div className="bg-white border border-stone-200 rounded-lg p-4">
        <span className="text-[11px] text-stone-500 uppercase tracking-wider">Chase Status</span>
